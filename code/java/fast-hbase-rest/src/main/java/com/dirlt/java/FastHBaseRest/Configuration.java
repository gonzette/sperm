...
public class Configuration {
    ...
    private int readHBaseTimeout = 10 * 1000; // ms
    private int writeHBaseTimeout = 10 * 1000; // ms
    ...
    public boolean parse(String[] args) {
        for (String arg : args) {
            ...
            } else if (arg.startsWith("--read-hbase-timeout=")) {
                readHBaseTimeout = Integer.valueOf(arg.substring("--read-hbase-timeout=".length()));
            } else if (arg.startsWith("--write-hbase-timeout=")) {
                writeHBaseTimeout = Integer.valueOf(arg.substring("--write-hbase-timeout=".length()));
    ...
    public static void usage() {
        ...
        System.out.println("\t--read-hbase-timeout # read hbase max timeout, default 10 * 1000(ms)");
        System.out.println("\t--write-hbase-timeout # write hbase max timeout, default 10 * 1000(ms)");
    ...
    public String toString() {
        ...
        sb.append(String.format("read-hbase-timeout=%d(ms), write-hbase-timeout=%d(ms)\n", getReadHBaseTimeout(), getWriteHBaseTimeout()));
    ...
    public int getReadHBaseTimeout() {
        return readHBaseTimeout;
    }

    public int getWriteHBaseTimeout() {
        return writeHBaseTimeout;
    }

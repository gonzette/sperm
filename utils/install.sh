...
TARGETS="2utf8 cxxindent oprof mysqldb syslog pinstall gc tpom vpn-umeng-dp vpn-dirlt-aws proc-netstat rhs golang pcrypt einstall uinstall clj lein scode imei2umid time-machine apt-update"

...
** About Me
My name is Zhang Yan. I graduated from [[http://www.sdu.edu.cn/][Shandong University]] as master, and currently work as Software Architect in Data Platform Team at [[http://www.umeng.com/][Umeng]] which focus on mobile analytics since 2012.5 where I manily work on building and improving the infrastructure of big data processing on [[http://hadoop.apache.org/][Hadoop]] and [[http://hbase.apache.org/][HBase]]. From 2010.7 to 2012.5, I have been a Senior Software Engineer at [[http://www.baidu.com/][Baidu]] Infrastructure Tream where I wrote libraries, tools, services and distributed systems. From 2008.8 to 2010.7, I have been a Intern Software Engineer at [[http://www.baidu.com/][Baidu]] Component Tream where I wrote libraries and tools. My linkedin written below has more details, and for the sake of seeking job I maintain a [[file:resume.org][resume]]. 

[[file:note.org][Here]] are my some notes written casually to record my life footprint. I may will take them like treasure when 30 years is past:). 

My code name is dirtysalt or dirlt. It's translated from my chinese name. The translation works as following:
   - Zhang pronounce like '脏' in cn which is the word of 'dirty'in en.
   - Yan pronounce like in '盐' in cn which is the word of 'salt' in en.

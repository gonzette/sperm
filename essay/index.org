...
** Network Programming
   ...
   - [[https://github.com/dirtysalt/sperm/tree/master/code/cc/itachi][itachi]] 自己两天时间写完的异步网络编程框架，当然有很多地方需要改进，但是内核基本稳定了。并且在上面做了asocket封装，编写网络程序非常方便。TODO(dirlt):考虑写篇文章介绍一些 
...
** Distributed System
   - [[file:distributed-system-reading.org][Distributed System Reading]] 关于分布式系统方面的一些文章以及阅读心得。
     ...
     - [[file:./project-voldemort-scaling-simple-storage-at-linkedin.org][Project Voldemort: Scaling Simple Storage at LinkedIn]]
   ...
   - [[file:power-drill.org][PowerDrill]] Dremel系统底层列式存储另外一种实现。
   ...
   - [[file:./cassandra.org][Cassandra]] 类Dynamo的开源分布式数据库。
   - [[file:./pnuts.org][PNUTS]] Yahoo的分布式数据库。
   - [[file:./voldemort.org][Voldemort]] a Dynamo like distributed key-value storage system.
   - [[file:riak.org][Riak]] a NoSQL database implementing the principles from Amazon's Dynamo paper in Erlang/C/C++/Javascript.
   - [[file:./couchbase.org][CouchBase]] CouchDB(by CouchOne) + [[file:memcached.org][Memcached]](by Membase). a Dynamo like distributed document-oriented storage system whose closest competitor is [[file:mongodb.org][MongoDB]]. 
...
** Software Design
   - [[file:./cross-ocean.org][Cross Ocean]] 远渡重洋
...
Here is my contact info. I think email is the easiest way to get me.
   ...
   - [[file:images/mysterious.gif][portrayal]]
   - btc
     - 12D9xRUorzQfAAVmFZvKqgySqRmc55DXTx
     - 1CRgxMewTAR7QpJBr4NYryxT3hcRMrWm8c
   - v2ex http://www.v2ex.com/?r=dirtysalt

My favouritest words comes from theidea of [[http://www.valvesoftware.com/][Valve]] : "Open your mind, Open your eyes" (放眼未来，自由想象), with a [[file:images/valve-logo.jpg][image]] from its game "Half Life"

Especially thanks to [[http://xuchaoqian.com][xuchaoqian]] for encouraging me to write and providing me host initially so I can publish my writings. And also thanks people who help me, support me, and accompany me, you complete me.
...
** Some Links
   ...
   - The Writings of Leslie Lamport : http://research.microsoft.com/en-us/um/people/lamport/pubs/pubs.html
   - Paper Trail : http://the-paper-trail.org/blog/
   - 250bpm : http://250bpm.com/

--------------------

   - Snooda's Blog : http://www.snooda.com/
